...
,('Unhide School', 'Cursos livres da área de Design e Ilustração', 'https://unhideschool.com/', 'API', 1, 'REAL')
,('Rocket Seat', 'Cursos livres da área de TI', 'https://www.rocketseat.com.br/', 'API', 1, 'SOCIAL')
,('Treina Web', 'Cursos livres da área de TI', 'https://www.treinaweb.com.br', 'API', 1, '')
,('School Of Net', 'Cursos livres da área de TI', 'https://www.schoolofnet.com/', 'API', 1, '')
,('Full Cycle', 'Cursos de especialização em TI', 'https://fullcycle.com.br/', 'API', 1, 'REAL')
,('Estratégia Medicina', 'Cursos preparatórios para a área de Medicina', 'https://med.estrategia.com', 'API', 1, 'SOCIAL')
,('Estratégia Concursos', 'Cursos preparatórios para concursos públicos', 'https://www.estrategiaconcursos.com.br/', 'MIXED', 1, 'SOCIAL')
...
,('Medcel', 'Cursos preparatórios para a área de Medicina', 'https://www.medcel.com.br/', 'API', 1, 'SOCIAL')
,('MedCurso', 'Cursos preparatórios para a área de Medicina', 'https://www.medcurso.com.br/', 'API', 1, 'SOCIAL,REAL')
,('MedCof', 'Cursos preparatórios para a área de Medicina', 'https://www.medcof.com.br/', 'HTML', 1, 'SOCIAL');
